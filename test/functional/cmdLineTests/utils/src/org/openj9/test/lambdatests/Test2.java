...
public class Test2 {
    ...
    public void func(){
        ...
        System.out.print(strComparison);
            
        int x = 1134;
        Comparator<String> strComparator2= (String o1, String o2) -> o1.compareTo(o2)+o2.compareTo(o1)+1523+x;
        int strComparison2 = strComparator2.compare("a_cup_of", "tea");
        System.out.print(strComparison2);
    }
}
